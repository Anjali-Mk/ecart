        ...
        {cartArray?.length > 0 ?
                ...
                <tbody>
                  {cartArray?.map((item , index) => (
                    <tr>
                      ...
                      <td className='border  border-gray-100 p-3 text-center'> <button onClick={()=>dispatch (removeCartItem(item?.id))} className='bg-red-700 p-5 text-white rounded'><FontAwesomeIcon icon={faTrashCan} /> </button></td>
                    </tr>
                  ))
                  }
                </tbody>
          ...
          <div className='w-full mt-10 md:grid grid-cols-3 '>
            ...
            <div className='flex justify-center items-center flex-col my-10'>
              <img src="https://www.apathways.com/wp-content/uploads/2017/03/Empty-Cart.png" alt="no image" className='w-full h-80' />
